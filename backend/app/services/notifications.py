...
``app.schemas.inbox_kinds.NOTIFICATION_KINDS``, the single source every other
surface derives from. If you find yourself tempted to add another producer,
make sure it fits that definition — Realtime already covers immediacy
elsewhere, and comment/@mention notifications are deliberately out of scope.
