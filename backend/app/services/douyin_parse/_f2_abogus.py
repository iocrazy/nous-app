# backend/app/services/douyin_parse/_f2_abogus.py
#
# Vendored pure-Python a_bogus generator from the `f2` library.
# Source: https://github.com/Johnserf-Seed/f2/blob/main/f2/utils/abogus.py
# License: Apache License 2.0 (original copyright: JohnserfSeed)
#
# We vendor instead of `pip install f2` because f2 pulls in a large
# dependency tree (httpx pinned, cryptography, protobuf, browser-cookie3,
# etc.) that conflicts with our existing versions. Only the ABogus class
# is needed for Douyin URL signing.
#
# Runtime deps of this module only:
#   - gmssl (Chinese national standard SM3 hash)
#
# Keep this file byte-for-byte faithful to the upstream module so that
