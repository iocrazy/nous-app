    ...
    return CollectionListResponse(
        collections=[
            CollectionResponse(
                ...
                cached_count=c.get("cached_count", 0),
...
async def create_collection(
    ...
    return CollectionResponse(
        ...
        cached_count=created.get("cached_count", 0),
...
async def get_collection(
    ...
    return CollectionResponse(
        ...
        cached_count=collection.get("cached_count", 0),
...
async def update_collection(
    ...
    return CollectionResponse(
        ...
        cached_count=updated.get("cached_count", 0),
