# backend/tests/test_resolve_nous_model_by_actual.py
"""resolve_nous_model falls back to actual_model lookup.
...
@pytest.mark.asyncio
async def test_resolve_nous_model_falls_back_to_actual_model_when_name_misses():
    ...
    with patch(
        ...
        with patch(
            ...
            result = await h.resolve_nous_model(RAW_MODEL_ID, "chat")
...
@pytest.mark.asyncio
async def test_resolve_nous_model_prefers_name_match_over_actual_model_fallback():
    ...
    with patch(
        ...
        with patch(
            ...
            provider_key, provider_config, model = await h.resolve_nous_model(
...
@pytest.mark.asyncio
async def test_resolve_nous_model_returns_none_when_both_lookups_miss():
    ...
    with patch(
        ...
        result = await h.resolve_nous_model("gpt-4o", "chat")
