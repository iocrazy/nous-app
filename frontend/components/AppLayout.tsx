...
function AppLayoutInner() {
  ...
  const mainContentClass = `flex-1 ${sidebarCollapsed ? 'sm:ml-20' : 'sm:ml-64'} w-full transition-[margin] duration-300 ${
    view === 'resources'
      ? `${isDetailPage ? 'pt-0 pb-0' : 'pt-12 pb-20'} sm:h-screen sm:p-8 sm:pt-20 sm:pb-8 sm:overflow-hidden`
      : `${isDetailPage ? 'pt-0 pb-0' : 'px-4 pt-12 pb-20'} sm:px-8 sm:pt-20 sm:pb-8`
  }`;
