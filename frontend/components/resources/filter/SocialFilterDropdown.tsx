  ...
  return (
    <div className="w-max min-w-[18rem] py-1.5" role="menu" aria-label="Social filter">
        ...
        {SOCIAL_METRICS.map((metric) => {
          ...
          return (
            ...
            >
              ...
              <span
                className="text-[10px] tracking-wider text-content-3"
                aria-hidden="true"
              >
              ...
              <input
                ...
                className={`w-20 bg-card border rounded px-1.5 py-1 text-[11px] focus:outline-none focus:border-indigo-500 ${
                  entry.enabled
      ...
      <div className="px-3 py-2 border-t border-line">
        <label className="flex items-center gap-2 text-xs cursor-pointer text-content-2">
          <input
            type="checkbox"
