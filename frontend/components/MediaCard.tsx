      ...
      <div className="flex flex-col md:flex-row">
        ...
        <div className="flex-1 p-6 flex flex-col md:max-h-[70vh] overflow-y-auto custom-scrollbar">
          ...
          <div className="flex justify-between items-start mb-2">
            ...
            <span className="text-xs text-zinc-500 font-mono">ID: {data.platform_id}</span>
          </div>
          ...
          <div className="grid grid-cols-4 gap-4 mb-6">
            <div className="flex flex-col items-center justify-center p-3 bg-zinc-950 rounded-xl border border-zinc-800">
              ...
              <span className="text-sm font-bold text-white">{formatNumber(data.like_count)}</span>
            ...
            >
              ...
              <span className="text-sm font-bold text-white">{copiedShare ? 'Copied!' : formatNumber(data.share_count)}</span>
            ...
            <div className="flex flex-col items-center justify-center p-3 bg-zinc-950 rounded-xl border border-zinc-800">
              ...
              <span className="text-sm font-bold text-white">{formatNumber(data.favorite_count)}</span>
