    ...
    <div>
      ...
      {items.length === 0 ? (
        <div className="flex flex-col items-center justify-center h-64 gap-4 text-center">
          ...
          <div>
            <p className="text-sm font-medium text-ink-400">No scripts yet</p>
            <p className="text-xs text-ink-600 mt-1">Create a script to organize your story</p>
          </div>
          <button
            onClick={() => setShowCreateModal(true)}
              ...
              >
                <div className="flex items-start gap-3">
                  ...
                  <div className="min-w-0 flex-1">
                    <h4 className="truncate text-sm font-semibold text-ink-100">{script.name}</h4>
                  </div>
                </div>
                <div className="mt-3">
                  ...
                  {script.chapter_count != null && (
                    <span className="ml-2 text-[10px] text-ink-600">{script.chapter_count} chapters</span>
                  )}
                </div>
  ...
  return (
    ...
    >
      <div className="w-full max-w-sm rounded-xl bg-ink-900 border border-ink-700 shadow-2xl p-5">
        <div className="flex items-center justify-between mb-4">
          <h3 className="text-sm font-semibold text-ink-100">New Script</h3>
