  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      <div
        ...
        onClick={onClose}
      />
      <div className="relative bg-ink-900 border border-ink-800 rounded-2xl shadow-2xl w-full max-w-sm mx-4 animate-in fade-in zoom-in-95 duration-200">
        {/* Header */}
        <div className="flex items-center justify-between p-5 border-b border-ink-800">
          <div className="flex items-center gap-3">
            <div className="p-2 bg-[var(--accent-soft)] rounded-lg">
              <Coins size={20} className="text-[var(--accent-text)]" />
            </div>
        ...
        <div className="p-5 space-y-4">
          {isLoading ? (
            <div className="flex items-center justify-center py-6">
              <div className="w-5 h-5 rounded-full border-2 border-ink-600 border-t-indigo-400 animate-spin" />
              <span className="ml-2 text-sm text-ink-400">{t('common.loading', 'Loading...')}</span>
            </div>
          ) : hasError ? (
            ...
            <>
              {/* Cost display */}
              <div className="bg-ink-800/50 rounded-xl p-4 space-y-3">
                ...
                <div className="flex justify-between text-sm">
                  ...
                  <span className="text-ink-300">{balance} pts</span>
                </div>
