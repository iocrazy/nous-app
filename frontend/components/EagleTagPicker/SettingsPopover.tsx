      ...
      <div className="flex items-center justify-between py-1">
        ...
        <div className="flex gap-1">
          <button
            ...
            className={`p-1 rounded ${settings.layout === 'list' ? 'bg-[var(--accent-soft)] text-[var(--accent-text)]' : 'text-ink-500'}`}
          >
            <List size={14} />
          </button>
          <button
            onClick={() => onUpdate({ layout: 'grid' })}
            className={`p-1 rounded ${settings.layout === 'grid' ? 'bg-[var(--accent-soft)] text-[var(--accent-text)]' : 'text-ink-500'}`}
          >
            <LayoutGrid size={14} />
          </button>
        </div>
