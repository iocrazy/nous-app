...
describe('forkErrorText', () => {
  it('maps every typed refusal code to its copy', () => {
    for (const code of ['run_live', 'issue_busy', 'issue_terminal', 'not_a_step_boundary', 'not_an_issue_run', 'run_state_unavailable', 'dispatch_failed', 'release_failed', 'not_found']) {
