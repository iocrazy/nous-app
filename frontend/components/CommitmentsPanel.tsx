      ...
      <div className="flex-1 overflow-y-auto">
        {loading && items.length === 0 ? (
          ...
          <ul className="divide-y divide-ink-800">
            {items.map((c) => (
              <li key={c.id} className="px-3 py-2 hover:bg-ink-900/50 transition-colors">
                ...
                <div className="flex items-center justify-between mt-1.5">
                  ...
                  <div className="flex items-center gap-1">
                    ...
                    <button
                      ...
                      className="text-ink-500 hover:text-ink-300 hover:bg-ink-800 p-1 rounded transition-colors disabled:opacity-40"
