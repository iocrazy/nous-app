...
/** Like `handle`, but a non-2xx becomes a RunForkRejectedError carrying
 *  `detail.code` (FastAPI `{detail: {code, message}}`, or a plain string
 *  detail → `http_<status>`). Never the raw body. */
