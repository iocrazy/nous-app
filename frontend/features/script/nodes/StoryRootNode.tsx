...
export const StoryRootNode = memo(({ data }: NodeProps<StoryRootNode>) => {
  return (
    <div className="w-[200px] rounded-xl border border-zinc-600 bg-zinc-800/80 backdrop-blur-sm shadow-lg">
      {/* Story Name */}
      ...
      <div className="flex items-center gap-2 px-3 py-2">
        ...
        {data.genre && (
          <span className="ml-auto text-[10px] px-2 py-0.5 rounded bg-purple-600/20 text-purple-400 font-medium truncate max-w-[80px]">
            {data.genre}
          </span>
        )}
      </div>
